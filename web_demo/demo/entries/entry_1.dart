...
import '../../../examples/example/demo/buttons.dart';
import '../../../examples/example/demo/buttons.dart' as fw1;
...
Preview get fwPreview => Preview(name: 'Buttons', wrapper: wrapInApp);

Widget Function() get fwBuilder => fw1.buttons;
