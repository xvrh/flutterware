...
import '../../../examples/example/demo/vector_smoke.dart';
import '../../../examples/example/demo/vector_smoke.dart' as fw8;
...
Preview get fwPreview => Preview(name: 'Vector smoke', wrapper: wrapInApp);

Widget Function() get fwBuilder => fw8.vectorSmoke;
