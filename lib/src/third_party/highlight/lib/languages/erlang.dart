          ...
          contains: [
            ...
            Mode(
              ...
              contains: [
                ...
                Mode(
                  ref: '~contains~0~contains~0~contains~2~contains~4~contains~1~contains~6',
                ),
                Mode(
                  ref: '~contains~0~contains~0~contains~2~contains~4~contains~1~contains~6~contains~7',
                ),
                Mode(
                  ref: '~contains~0~contains~0~contains~2~contains~4~contains~1~contains~6~contains~8',
                ),
                Mode(
                  ref: '~contains~0~contains~0~contains~2~contains~4~contains~1~contains~6~contains~9',
                ),
              ],
            ),
          ],
  ...
  contains: [
    Mode(
      ...
      contains: [
        ...
        Mode(className: "title", begin: "[a-z'][a-zA-Z0-9_']*", relevance: 0),
      ],
      starts: Mode(
        end: ";|\\.",
        keywords: {
