  ...
  refs: {
    ...
    '~contains~6~contains~0~contains~0~variants~0~contains~1~contains~1': Mode(
      ...
      variants: [
        ...
        Mode(
          ref: '~contains~6~contains~0~contains~0~variants~0~contains~1~contains~1~variants~1',
        ),
        Mode(
          ref: '~contains~6~contains~0~contains~0~variants~0~contains~1~contains~1~variants~2',
        ),
      ],
    ),
