...
final ruby = Mode(
  refs: {
      ...
      contains: [
        ...
        Mode(
          ...
          contains: [
            ...
            Mode(
              ref: '~contains~3~starts~contains~0~contains~1~contains~3~contains~1~contains~4',
            ),
            Mode(
              ref: '~contains~3~starts~contains~0~contains~1~contains~3~contains~1~contains~5',
            ),
            Mode(
              ref: '~contains~3~starts~contains~0~contains~1~contains~3~contains~1~contains~6',
            ),
            Mode(
              ref: '~contains~3~starts~contains~0~contains~1~contains~3~contains~1~contains~7',
            ),
            Mode(
              ref: '~contains~3~starts~contains~0~contains~1~contains~3~contains~1~contains~8',
            ),
            Mode(
              ref: '~contains~3~starts~contains~0~contains~1~contains~3~contains~1~contains~9',
            ),
            Mode(
              ref: '~contains~3~starts~contains~0~contains~1~contains~3~contains~1~contains~10',
            ),
            Mode(ref: '~contains~0'),
            Mode(ref: '~contains~1'),
            Mode(ref: '~contains~2'),
    ...
    '~contains~3~starts~contains~0~contains~1~contains~1': Mode(
      begin: "#<",
      end: ">",
    ),
    '~contains~3~starts~contains~0~contains~1': Mode(
      className: "subst",
      begin: "#\\{",
      end: "}",
      keywords: {
    ...
    '~contains~3~starts~contains~0': Mode(
      className: "string",
      contains: [
        BACKSLASH_ESCAPE,
        Mode(ref: '~contains~3~starts~contains~0~contains~1'),
