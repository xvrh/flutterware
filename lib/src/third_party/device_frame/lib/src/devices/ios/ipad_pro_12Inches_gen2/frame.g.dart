...
class _FramePainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    paint_2_fill.color = Color(0xff262C2D).withValues(alpha: 1.0);
    ...
    paint_3_fill.color = Color(0xff262C2D).withValues(alpha: 1.0);
    ...
    paint_4_fill.color = Color(0xff121515).withValues(alpha: 1.0);
    ...
    paint_5_fill.color = Color(0xff636F73).withValues(alpha: 1.0);
