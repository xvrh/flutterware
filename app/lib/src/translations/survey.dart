...
class LoadedCatalog {
  ...
  /// glob that matched nothing, or files that were read under the wrong
  /// [CatalogLayout] and yielded no key. The two are one sentence apart and
  /// send a reader to opposite ends of the declaration.
