...
// The fresh-worktree case: `.fvmrc` is versioned, the `.fvm/flutter_sdk`
// symlink is not — so before anyone runs `fvm use`, the pin resolved against
// fvm's cache is the only project-scoped answer discovery can give.
void main() {
  late Directory tmp;
