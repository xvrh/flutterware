...
void main() {
  ...
  test(
    'runIntercepted captures child output and returns its exit code',
    () async {
  ...
  test(
    'runIntercepted propagates a non-zero exit code',
    () async {
  ...
  test(
    'runIntercepted captures stderr into the sink',
    () async {
