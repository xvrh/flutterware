...
void main() {
  ...
  test('drops the SDK and the pub cache', () {
    ...
    var deps = readDaemonDepfile(
      depfile(
        [
          config(),
          at('app/lib/src/catalog/protocol.dart'),
    ...
    expect(deps, [config(), at('app/lib/src/catalog/protocol.dart')]);
  });
  ...
  test('a path with a space in it survives', () {
    ...
    var spaced = at('My Projects/app/lib/src/catalog/protocol.dart');
    var deps = readDaemonDepfile(
